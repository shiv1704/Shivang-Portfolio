...
export const metadata = {
  title: "EY Techathon 6.0 — Agentic AI for B2B RFPs | Shivang Sharma",
};

export default function EYTechathonPage() {
  const project = projects.find((p) => p.slug === "ey-techathon")!;
      ...
      <Container>
        ...
        <div className="flex flex-col items-center rounded-2xl border border-dashed border-ink/15 py-20 text-center">
          ...
          <p className="mt-3 max-w-md font-sans text-sm text-muted/60">
            This will include problem framing, solution architecture, results, and
            learnings — formatted as an editorial case study.
          </p>
        </div>
      </Container>
    </div>
